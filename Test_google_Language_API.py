...
#set environmental variable to point to authentication json file
	os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "C:\\Users\\martinezg1\\Documents\\New folder\\auth.json"
